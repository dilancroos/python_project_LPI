...
class json_fileTestCase(TestCase):
    ...
    def test_json_calaries_combo_complex_id_unknown(self):
        result = comp_cal_counter_json('combo-1', 'combo-2', 'Unknown')
        self.assertEqual(result, 1770, f"Expected 1770, got {result}")
    ...
    def test_json_calaries_combo_complex_name_unknown(self):
        result = comp_cal_counter_json('cheesy combo', 'veggie combo', 'Unknown')
        self.assertEqual(result, 1770, f"Expected 1770, got {result}")
    ...
    def test_json_calaries_complex_mix_id_unknown(self):
        result = comp_cal_counter_json('meal-1', 'combo-2', 'Unknown')
        self.assertEqual(result, 1300, f"Expected 1300, got {result}")
    ...
    def test_json_calaries_complex_mix_name_unknown(self):
        result = comp_cal_counter_json('hamburger', 'veggie combo', 'Unknown')
        self.assertEqual(result, 1300, f"Expected 1300, got {result}")
    ...
    def test_json_price_complex_id_unknown(self):
        result = price_counter_json('meal-1', 'meal-2', 'meal-3', 'Unknown')
        self.assertEqual(result, 18, f"Expected 18, got {result}")
    ...
    def test_json_price_complex_name_unknown(self):
        result = price_counter_json('hamburger','salad','iced tea', 'Unknown')
        self.assertEqual(result, 11, f"Expected 11, got {result}")